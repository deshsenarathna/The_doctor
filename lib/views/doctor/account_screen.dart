...
import '../../viewmodel/doctor_account_viewmodel.dart';
...
class _DoctorAccountScreenState extends State<DoctorAccountScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<DoctorAccountViewModel>().load().then((_) {
        final vm = context.read<DoctorAccountViewModel>();
  ...
  Widget build(BuildContext context) {
    final vm = context.watch<DoctorAccountViewModel>();
    return Scaffold(
                                ...
                                onPressed: () async {
                                  final confirm = await showDialog<bool>(
                                    ...
                                    builder: (ctx) => AlertDialog(
                                      ...
                                      content: const Text('This will permanently delete your account, sessions, and related appointments. Continue?'),
                                      actions: [
